...
import net.hellomouse.kontrol.entity.ImplementedInventory;
...
public class FurnaceGeneratorEntity extends AbstractElectricalBlockEntity implements ImplementedInventory, SidedInventory, NamedScreenHandlerFactory, Tickable {
