...
/**
 * MUC Port Maker screen
 * @author Bowserinator
 */
@Environment(EnvType.CLIENT)
public class CreativeMUCPortMakerScreen extends HandledScreen<ScreenHandler> {
    ...
    public CreativeMUCPortMakerScreen(ScreenHandler handler, PlayerInventory inventory, Text title) {
        super(handler, inventory, title);

        if (handler instanceof CreativeMUCPortMakerScreenHandler) {
            CreativeMUCPortMakerScreenHandler screenHandler = ((CreativeMUCPortMakerScreenHandler)handler);
    ...
    private void done() {
        ...
        ClientSidePacketRegistry.INSTANCE.sendToServer(MUCBlockRegistry.MUC_PORT_MAKER_PACKET_ID, passedData);
        this.close();
    }
