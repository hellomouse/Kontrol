...
const int SYSCLK = 22118400;
const int BAUDRATE = 38400; // TODO: remove for #define
...
void UART0_Init(void)
{
   ...
   TH1    = 0xFF&-(SYSCLK/BAUDRATE/16);     // set Timer1 reload value for baudrate
   TR1    = 1;                         // start Timer1
